    ...
    <div class="container-fluid">
        <div class="container col-md-5">
            ...
            <form action="./Action/ActionNewAuto.php" method="POST" class="needs-validation row-md-4" novalidate>
                <div>
                    <label>Patente: </label><input type="text" pattern="[A-Z]{3}\s[0-9]{3}" name="Patente" id="Patente" class="form-control text">
                ...
                <div>
                    <label>Marca: </label><input type="text" pattern="[a-zA-Z]+\s?[a-zA-Z]*" name="Marca" id="Marca" class="form-control text">
                    <div class="invalid-feedback">
                ...
                <div>
                    <label>Modelo: </label><input type="text" pattern="[a-zA-Z]*[0-9]*" name="Modelo" id="Modelo" class="form-control">
                    <div class="invalid-feedback">
                        Debe ingregar una marca que exista
                    </div>
                    <div class="valid-feedback">
                ...
                <div>
                    <label>DNI del Dueño: </label><input type="number" min="1000000" name="DniDuenio" id="DniDuenio" class="form-control">
                    <div class="invalid-feedback">

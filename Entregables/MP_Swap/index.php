...
<head>
    ...
    <link rel="stylesheet" href="./View/Assets/css/bootstrap.min.css.map">
    <script src="./View/Assets/js/bootstrap.bundle.js"></script>
    <script src="./View/Assets/js/bootstrap.bundle.js.map"></script>
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-4 d-flex align-items-center">
                ...
                <span class="mb-3 mb-md-0 text-light">© 2022 SAVA</span>
            </div>
